...
// Users - post
// Required data: name, email, street address, password, creditCard
// Optional data: none
...
handlers._users.post = function( data,callback ) {
    ...
    var creditCard = typeof(data.payload.creditCard) == 'string' && data.payload.creditCard.trim().length > 0 && data.payload.creditCard.match(/^\d+$/) ? data.payload.creditCard.trim() : false;
